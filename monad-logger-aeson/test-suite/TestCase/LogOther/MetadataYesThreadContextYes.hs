...
module TestCase.LogOther.MetadataYesThreadContextYes
  ( testCase
  ) where
        ...
        [aesonQQ|
          {
            ...
            "location": {
              "package": "main",
              "module": "TestCase.LogOther.MetadataYesThreadContextYes",
              "file": "test-suite/TestCase/LogOther/MetadataYesThreadContextYes.hs",
              "line": 23,
              "char": 11
            },
            "context": {
    ...
    , expectedLoggedMessage =
        LoggedMessage
          ...
          , loggedMessageLoc =
              Just Loc
                { loc_package = "main"
                , loc_module = "TestCase.LogOther.MetadataYesThreadContextYes"
                , loc_filename = "test-suite/TestCase/LogOther/MetadataYesThreadContextYes.hs"
                , loc_start = (23, 11)
                , loc_end = (0, 0)
                }
