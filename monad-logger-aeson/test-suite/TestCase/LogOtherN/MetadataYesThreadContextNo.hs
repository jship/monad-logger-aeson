...
module TestCase.LogOtherN.MetadataYesThreadContextNo
  ( testCase
  ) where

import Control.Monad.Logger.Aeson ((.=), Loc(..), LogLevel(..), LoggedMessage(..), Message(..), logOtherN)
        ...
        [aesonQQ|
          {
            ...
            "location": {
              "package": "main",
              "module": "TestCase.LogOtherN.MetadataYesThreadContextNo",
              "file": "test-suite/TestCase/LogOtherN/MetadataYesThreadContextNo.hs",
              "line": 19,
              "char": 9
            },
            "message": {
    ...
    , expectedLoggedMessage =
        LoggedMessage
          ...
          , loggedMessageLoc =
              Just Loc
                { loc_package = "main"
                , loc_module = "TestCase.LogOtherN.MetadataYesThreadContextNo"
                , loc_filename = "test-suite/TestCase/LogOtherN/MetadataYesThreadContextNo.hs"
                , loc_start = (19, 9)
                , loc_end = (0, 0)
                }
